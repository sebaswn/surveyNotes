<script>
    ...
    import Subtract from "carbon-icons-svelte/lib/Add.svelte";
    import WarningFilled from "carbon-icons-svelte/lib/Add.svelte";
    import WarningAltFilled from "carbon-icons-svelte/lib/Add.svelte";
    import EditOff from "carbon-icons-svelte/lib/Add.svelte";
